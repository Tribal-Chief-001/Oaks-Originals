...
- Name: responsive.spec.ts >> Pokédex Responsive Design & Search Filters >> should search for a Pokemon and filter the list
- Location: src/__tests__/e2e/responsive.spec.ts:19:7
...
Call log:
  - waiting for getByPlaceholder('Search Pokémon by name or ID...')
